...
void printArrray(int grades[][EXAMS], int pupils, int tests);
void printMenu();
int main() {
	...
	void(*processGrages[4])(int[STUDENTS][EXAMS], int, int)
		= { printArrray,minimum,maximum,average };
...
void printMenu()
{
	...
	printf("\t1 Find the minmum grades\n");
	printf("\t2 Find the maxmum grades\n");
